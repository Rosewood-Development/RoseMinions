...
public class BlockBreakModule extends MinionModule {
    ...
    public static class Settings implements MinionSettingHolder {
        ...
        public static final MinionSetting<Long> BREAK_FREQUENCY = define(MinionSetting.ofLong("break-frequency", 1000L, "How often blocks will be broken (in milliseconds)"));
        public static final MinionSetting<Integer> BREAK_AMOUNT = define(MinionSetting.ofInteger("break-amount", 1, "How many blocks to break at a time"));
