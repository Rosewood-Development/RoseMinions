...
public class FishingModule extends MinionModule {
    ...
    public static class Settings implements PDCSettingHolder {
        ...
        public static final MinionSetting<PlayableSound> REEL_IN_SOUND = define(MinionSetting.of("reel-in-sound", PlayableSound.SERIALIZER, () -> new PlayableSound(true, Sound.ENTITY_FISHING_BOBBER_RETRIEVE, SoundCategory.PLAYERS, 0.25f, 1.0f), "The sound to play when the minion reels in a fish"));
        public static final MinionSetting<PlayableSound> BOBBER_SOUND = define(MinionSetting.of("fish-caught-sound", PlayableSound.SERIALIZER, () -> new PlayableSound(true, Sound.ENTITY_FISHING_BOBBER_SPLASH, SoundCategory.PLAYERS, 0.25f, 1.0f), "The sound to play when a fish is caught on the bobber"));
