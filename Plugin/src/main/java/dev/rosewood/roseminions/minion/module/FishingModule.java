...
public class FishingModule extends MinionModule {
    ...
    public static class Settings implements ModuleSettings {
        ...
        public static final SettingAccessor<PlayableSound> REEL_IN_SOUND = define(SettingAccessor.defineSetting(PlayableSound.SERIALIZER, "reel-in-sound", () -> new PlayableSound(Sound.ENTITY_FISHING_BOBBER_RETRIEVE, SoundCategory.PLAYERS, 0.25f, 1.0f), "The sound to play when the minion reels in a fish"));
        public static final SettingAccessor<PlayableSound> BOBBER_SOUND = define(SettingAccessor.defineSetting(PlayableSound.SERIALIZER, "fish-caught-sound", () -> new PlayableSound(Sound.ENTITY_FISHING_BOBBER_SPLASH, SoundCategory.PLAYERS, 0.25f, 1.0f), "The sound to play when a fish is caught on the bobber"));
