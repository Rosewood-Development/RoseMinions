...
public abstract class DataSerializer<T> {
    ...
    public DataSerializer(Class<T> type, PersistentDataType<?, T> persistentDataType, Function<T, String> asStringFunction, Function<String, T> fromStringFunction) {
        this.type = type;
    ...
    public DataSerializer(Class<T> type, PersistentDataType<?, T> persistentDataType) {
        this(type, persistentDataType, null, null);
    }

    public DataSerializer(PersistentDataType<?, T> persistentDataType) {
     ...
     * @param value The value to save
     */
    public final void write(ConfigurationSection config, MinionSetting<T> setting, T value) {
     ...
     * @param value The value to save
     */
    public final void writeWithDefault(ConfigurationSection config, MinionSetting<T> setting, T value) {
    ...
    static <T> String[] appendDefaultComment(DataSerializer<T> serializer, T value, String[] comments) {
     ...
     * @param value The value to save
     */
    public final void write(PersistentDataContainer container, MinionSetting<T> setting, T value) {
     ...
     * @return the value read
     */
    public final T read(ConfigurationSection config, MinionSetting<T> setting) {
     ...
     * @return true if the setting exists in the given config
     */
    public final boolean readIsValid(ConfigurationSection config, MinionSetting<T> setting) {
     ...
     * @return the value read
     */
    public final T read(PersistentDataContainer container, MinionSetting<T> setting) {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof DataSerializer<?> that)) return false;
