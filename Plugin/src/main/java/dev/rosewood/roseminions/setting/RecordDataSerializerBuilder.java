...
import static dev.rosewood.roseminions.setting.DataSerializerFactories.getOrCreateSection;

public class RecordDataSerializerBuilder<O> {

    private final Class<O> type;
    private DataSerializer<O> serializer;

    private RecordDataSerializerBuilder(Class<O> type) {
        this.type = type;
    }
    ...
    private static <T, O> T getValueOrDefault(ConfigurationSection section, SettingField<O, T> settingField) {
        ...
        T value = settingField.dataSerializer().read(section, settingField.key());
        if (value == null)
    ...
    private static <T, O> T getPersistentValueOrDefault(PersistentDataContainer container, SettingField<O, T> settingField) {
        T value = settingField.dataSerializer().read(container, settingField.key());
        if (value == null)
            value = settingField.defaultValue();
        return value;
    }
    ...
    private static <T, O> void writeConfigurationField(ConfigurationSection section, SettingField<O, T> settingField, O value, boolean writeDefaults) {
        ...
        if (settingField.dataSerializer().readIsValid(checkSection, settingField.key()))
            return;

        if (writeDefaults) {
            settingField.dataSerializer().writeWithDefault(section, settingField.key(), settingField.getter().apply(value), settingField.comments());
        } else {
            settingField.dataSerializer().write(section, settingField.key(), settingField.getter().apply(value), settingField.comments());
        }
    ...
    private static <T, O> boolean testSection(ConfigurationSection section, SettingField<O, T> settingField) {
        ...
        if (settingField.flatten())
            section = liftSection(section, settingField.key());
        return settingField.dataSerializer().readIsValid(section, settingField.key());
    }

    public static <O> DataSerializer<O> create(Class<O> clazz, Function<RecordDataSerializerBuilder<O>, Built<O>> builder) {
        Built<O> built = builder.apply(new RecordDataSerializerBuilder<>(clazz));
        RecordDataSerializerBuilder<O> instance = built.instance();
    ...
    <T1> Built<O> build1(Function<T1, O> constructor,
        ...
        PersistentDataType<PersistentDataContainer, O> persistentDataType = new PersistentDataType<PersistentDataContainer, O>() {
            ...
            public Class<O> getComplexType() {
                return RecordDataSerializerBuilder.this.type;
            }
            @Override
            public PersistentDataContainer toPrimitive(O complex, PersistentDataAdapterContext context) {
                PersistentDataContainer container = context.newPersistentDataContainer();
                settingField1.dataSerializer().write(container, settingField1.key(), settingField1.getter().apply(complex));
                return container;
            }
            @Override
        ...
        this.serializer = new DataSerializer<O>(this.type, persistentDataType) {
            @Override
    ...
    <T1, T2> Built<O> build2(BiFunction<T1, T2, O> constructor,
        ...
        PersistentDataType<PersistentDataContainer, O> persistentDataType = new PersistentDataType<PersistentDataContainer, O>() {
            ...
            public PersistentDataContainer toPrimitive(O complex, PersistentDataAdapterContext context) {
                PersistentDataContainer container = context.newPersistentDataContainer();
                settingField1.dataSerializer().write(container, settingField1.key(), settingField1.getter().apply(complex));
                settingField2.dataSerializer().write(container, settingField2.key(), settingField2.getter().apply(complex));
                return container;
            }
            @Override
            public O fromPrimitive(PersistentDataContainer primitive, PersistentDataAdapterContext context) {
    ...
    <T1, T2, T3> Built<O> build3(Functions.Function3<T1, T2, T3, O> constructor,
        ...
        PersistentDataType<PersistentDataContainer, O> persistentDataType = new PersistentDataType<PersistentDataContainer, O>() {
            ...
            public PersistentDataContainer toPrimitive(O complex, PersistentDataAdapterContext context) {
                ...
                settingField1.dataSerializer().write(container, settingField1.key(), settingField1.getter().apply(complex));
                settingField2.dataSerializer().write(container, settingField2.key(), settingField2.getter().apply(complex));
                settingField3.dataSerializer().write(container, settingField3.key(), settingField3.getter().apply(complex));
                return container;
            }
            @Override
            public O fromPrimitive(PersistentDataContainer primitive, PersistentDataAdapterContext context) {
    ...
    <T1, T2, T3, T4> Built<O> build4(Functions.Function4<T1, T2, T3, T4, O> constructor,
        ...
        PersistentDataType<PersistentDataContainer, O> persistentDataType = new PersistentDataType<PersistentDataContainer, O>() {
            ...
            public PersistentDataContainer toPrimitive(O complex, PersistentDataAdapterContext context) {
                ...
                settingField2.dataSerializer().write(container, settingField2.key(), settingField2.getter().apply(complex));
                settingField3.dataSerializer().write(container, settingField3.key(), settingField3.getter().apply(complex));
                settingField4.dataSerializer().write(container, settingField4.key(), settingField4.getter().apply(complex));
                return container;
            }
            @Override
            public O fromPrimitive(PersistentDataContainer primitive, PersistentDataAdapterContext context) {
    ...
    <T1, T2, T3, T4, T5> Built<O> build5(Functions.Function5<T1, T2, T3, T4, T5, O> constructor,
        ...
        PersistentDataType<PersistentDataContainer, O> persistentDataType = new PersistentDataType<PersistentDataContainer, O>() {
            ...
            public PersistentDataContainer toPrimitive(O complex, PersistentDataAdapterContext context) {
                ...
                settingField3.dataSerializer().write(container, settingField3.key(), settingField3.getter().apply(complex));
                settingField4.dataSerializer().write(container, settingField4.key(), settingField4.getter().apply(complex));
                settingField5.dataSerializer().write(container, settingField5.key(), settingField5.getter().apply(complex));
                return container;
            }
            @Override
            public O fromPrimitive(PersistentDataContainer primitive, PersistentDataAdapterContext context) {
    ...
    <T1, T2, T3, T4, T5, T6> Built<O> build6(Functions.Function6<T1, T2, T3, T4, T5, T6, O> constructor,
        ...
        PersistentDataType<PersistentDataContainer, O> persistentDataType = new PersistentDataType<PersistentDataContainer, O>() {
            ...
            public PersistentDataContainer toPrimitive(O complex, PersistentDataAdapterContext context) {
                ...
                settingField4.dataSerializer().write(container, settingField4.key(), settingField4.getter().apply(complex));
                settingField5.dataSerializer().write(container, settingField5.key(), settingField5.getter().apply(complex));
                settingField6.dataSerializer().write(container, settingField6.key(), settingField6.getter().apply(complex));
                return container;
            }
            @Override
            public O fromPrimitive(PersistentDataContainer primitive, PersistentDataAdapterContext context) {
    ...
    <T1, T2, T3, T4, T5, T6, T7> Built<O> build7(Functions.Function7<T1, T2, T3, T4, T5, T6, T7, O> constructor,
        ...
        PersistentDataType<PersistentDataContainer, O> persistentDataType = new PersistentDataType<PersistentDataContainer, O>() {
            ...
            public PersistentDataContainer toPrimitive(O complex, PersistentDataAdapterContext context) {
                ...
                settingField5.dataSerializer().write(container, settingField5.key(), settingField5.getter().apply(complex));
                settingField6.dataSerializer().write(container, settingField6.key(), settingField6.getter().apply(complex));
                settingField7.dataSerializer().write(container, settingField7.key(), settingField7.getter().apply(complex));
                return container;
            }
            @Override
            public O fromPrimitive(PersistentDataContainer primitive, PersistentDataAdapterContext context) {
    ...
    <T1, T2, T3, T4, T5, T6, T7, T8> Built<O> build8(Functions.Function8<T1, T2, T3, T4, T5, T6, T7, T8, O> constructor,
        ...
        PersistentDataType<PersistentDataContainer, O> persistentDataType = new PersistentDataType<PersistentDataContainer, O>() {
            ...
            public PersistentDataContainer toPrimitive(O complex, PersistentDataAdapterContext context) {
                ...
                settingField6.dataSerializer().write(container, settingField6.key(), settingField6.getter().apply(complex));
                settingField7.dataSerializer().write(container, settingField7.key(), settingField7.getter().apply(complex));
                settingField8.dataSerializer().write(container, settingField8.key(), settingField8.getter().apply(complex));
                return container;
            }
            @Override
            public O fromPrimitive(PersistentDataContainer primitive, PersistentDataAdapterContext context) {
    ...
    <T1, T2, T3, T4, T5, T6, T7, T8, T9> Built<O> build9(Functions.Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, O> constructor,
        ...
        PersistentDataType<PersistentDataContainer, O> persistentDataType = new PersistentDataType<PersistentDataContainer, O>() {
            ...
            public PersistentDataContainer toPrimitive(O complex, PersistentDataAdapterContext context) {
                ...
                settingField7.dataSerializer().write(container, settingField7.key(), settingField7.getter().apply(complex));
                settingField8.dataSerializer().write(container, settingField8.key(), settingField8.getter().apply(complex));
                settingField9.dataSerializer().write(container, settingField9.key(), settingField9.getter().apply(complex));
                return container;
            }
            @Override
            public O fromPrimitive(PersistentDataContainer primitive, PersistentDataAdapterContext context) {
    ...
    <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> Built<O> build10(Functions.Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, O> constructor,
        ...
        PersistentDataType<PersistentDataContainer, O> persistentDataType = new PersistentDataType<PersistentDataContainer, O>() {
            ...
            public PersistentDataContainer toPrimitive(O complex, PersistentDataAdapterContext context) {
                ...
                settingField8.dataSerializer().write(container, settingField8.key(), settingField8.getter().apply(complex));
                settingField9.dataSerializer().write(container, settingField9.key(), settingField9.getter().apply(complex));
                settingField10.dataSerializer().write(container, settingField10.key(), settingField10.getter().apply(complex));
                return container;
            }
            @Override
            public O fromPrimitive(PersistentDataContainer primitive, PersistentDataAdapterContext context) {
    ...
    <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> Built<O> build11(Functions.Function11<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, O> constructor,
        ...
        PersistentDataType<PersistentDataContainer, O> persistentDataType = new PersistentDataType<PersistentDataContainer, O>() {
            ...
            public PersistentDataContainer toPrimitive(O complex, PersistentDataAdapterContext context) {
                ...
                settingField9.dataSerializer().write(container, settingField9.key(), settingField9.getter().apply(complex));
                settingField10.dataSerializer().write(container, settingField10.key(), settingField10.getter().apply(complex));
                settingField11.dataSerializer().write(container, settingField11.key(), settingField11.getter().apply(complex));
                return container;
            }
            @Override
            public O fromPrimitive(PersistentDataContainer primitive, PersistentDataAdapterContext context) {
    ...
    <T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12> Built<O> build12(Functions.Function12<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, O> constructor,
        ...
        PersistentDataType<PersistentDataContainer, O> persistentDataType = new PersistentDataType<PersistentDataContainer, O>() {
            ...
            public PersistentDataContainer toPrimitive(O complex, PersistentDataAdapterContext context) {
                ...
                settingField10.dataSerializer().write(container, settingField10.key(), settingField10.getter().apply(complex));
                settingField11.dataSerializer().write(container, settingField11.key(), settingField11.getter().apply(complex));
                settingField12.dataSerializer().write(container, settingField12.key(), settingField12.getter().apply(complex));
                return container;
            }
            @Override
            public O fromPrimitive(PersistentDataContainer primitive, PersistentDataAdapterContext context) {
    ...
    public static class Built<T> {
        ...
        private final RecordDataSerializerBuilder<T> instance;

        private Built(RecordDataSerializerBuilder<T> instance) {
            this.instance = instance;
        }

        private RecordDataSerializerBuilder<T> instance() {
