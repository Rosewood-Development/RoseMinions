...
import dev.rosewood.roseminions.nms.v1_18_R2.entity.FakeFishingHook;
import dev.rosewood.roseminions.nms.v1_18_R2.hologram.HologramImpl;
...
public class NMSHandlerImpl implements NMSHandler {
    ...
    public List<ItemStack> getFishingLoot(Entity looter, Location location, ItemStack fishingRod) {
        ...
        LootContext context = new LootContext.Builder(level)
                ...
                .withOptionalParameter(LootContextParams.THIS_ENTITY, ((CraftEntity) looter).getHandle())
